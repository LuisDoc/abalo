...
<body>
    ...
    <script type="text/x-template" id="body">
        <div class ="h-screen bg-cgray mt-10">
            <button v-if='contentSwitch != "landingPage"' @click="handleSwitchToLandingPage" class ="px-5 mt-10 ml-64 bg-purple border border-purple text-3xl text-white hover:bg-white hover:text-purple rounded-lg ">
                Zurück
            </button>
            <template v-if='contentSwitch == "landingPage"'>
            ...
            <template v-if='contentSwitch == "impressum"'>
        ...
        <div class="bg-black text-white">
            <div class="pl-24 pr-24 pb-24 pt-20">
                ...
                <div class="flex mt-5">
                    ...
                    <a class="text-xs mr-4" @click.prevent ="handleSwitchToImpressum" href="">Impressum</a>
